...
FreakoutMoves             = 50000  #after this many moves, the viruses will replicate and mutate at a much greater rate
VirusMoves                = 0      #used to count how many times the viruses have moved
ClumpingSpeed             = 15     #This modifies the speed of viruses that contact each other
ReplicationSpeed          = 2      #When a virus replicates, it will be a bit slower.  This number is added to current speed.
...
DominanceMaxCount         = 50000   #how many ticks with there being only one virus, when reached level over
...
ChanceOfHeadingToHV       = 150000 #random chance of all viruses being interested in the same location
...
ChanceOfTurningIntoWall   = 5      #Random chance of a dying mutating virus to turn into a wall
...
BigFoodRGB                = (255,0,0)
MaxRandomViruses          = 30     #maximum number of random viruses to place on big food maps
VirusMaxCount             = 30      #maximum number of unique virus strains allowed
MaxLevelsPlayed           = 10      #quit after 5 maps are played
